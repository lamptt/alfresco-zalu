...
if (typeof jQuery !== "undefined" && typeof saveAs !== "undefined") {
    (function($) {
        $.fn.wordExportBaoCaoChiTiet = function(fileName, data, ten, loai, kiemtra) {
            //alert("Name 0: " + data.items[0].name);
        	...
        	{	
            	...
            	if(kiemtra == "username" && data.Object[i].cru1p1 == 1)
            	{		
            		stt ++;
            		sofile = data.Object[i].ChuaNhap + data.Object[i].DayDu;
            		totalsotrang += data.Object[i].SoTrang;
            		totalsofile += sofile;
            		totalchuanhap += data.Object[i].ChuaNhap;
            		totaldaydu += data.Object[i].DayDu;
            		chuoi += "<tr style='mso-yfti-irow:2'><td style='border-top:none;border-left:none;border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;mso-border-bottom-alt:solid windowtext .75pt;mso-border-right-alt:solid windowtext .75pt;padding:0in 0in 0in 0in'><p class=MsoNormal align=center style='margin-top:1.5pt;margin-right:1.5pt;margin-bottom:1.5pt;margin-left:2.0pt;text-align:center'>"+stt+"</p></td><td style='border-top:none;border-left:none;border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;mso-border-bottom-alt:solid windowtext .75pt;mso-border-right-alt:solid windowtext .75pt;padding:0in 0in 0in 0in'><p class=MsoNormal style='margin-top:1.5pt;margin-right:1.5pt;margin-bottom:1.5pt;margin-left:2.0pt'>"+ data.Object[i].cru1p0 +"</p></td><td style='border-top:none;border-left:none;border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;mso-border-bottom-alt:solid windowtext .75pt;mso-border-right-alt:solid windowtext .75pt;padding:0in 0in 0in 0in'><p class=MsoNormal align=center style='margin-top:1.5pt;margin-right:1.5pt;margin-bottom:1.5pt;margin-left:2.0pt;text-align:center'>"+data.Object[i].SoTrang+"</p></td><td style='border-top:none;border-left:none;border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;mso-border-bottom-alt:solid windowtext .75pt;mso-border-right-alt:solid windowtext .75pt;padding:0in 0in 0in 0in'><p class=MsoNormal align=center style='margin-top:1.5pt;margin-right:1.5pt;margin-bottom:1.5pt;margin-left:2.0pt;text-align:center'>"+sofile+"</p></td><td style='border-top:none;border-left:none;border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;mso-border-bottom-alt:solid windowtext .75pt;mso-border-right-alt:solid windowtext .75pt;padding:0in 0in 0in 0in'><p class=MsoNormal align=center style='margin-top:1.5pt;margin-right:1.5pt;margin-bottom:1.5pt;margin-left:2.0pt;text-align:center'>"+ data.Object[i].DayDu +"</p></td><td style='border-top:none;border-left:none;border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;mso-border-bottom-alt:solid windowtext .75pt;mso-border-right-alt:solid windowtext .75pt;padding:0in 0in 0in 0in'><p class=MsoNormal align=center style='margin-top:1.5pt;margin-right:1.5pt;margin-bottom:1.5pt;margin-left:2.0pt;text-align:center'><o:p>&nbsp;</o:p>"+ data.Object[i].ChuaNhap +"</p></td></tr> ";
            	}
            	else if(kiemtra == "year" && data.Object[i].cru1p1 == 0)
        		{
            		stt ++;
            		sofile = data.Object[i].ChuaNhap + data.Object[i].DayDu;
            		totalsotrang += data.Object[i].SoTrang;
...
$(".detaill").click(function(){
	...
	var text = '{"typeNode":"'+ loai +'","information":'+ chuanhap +',"folderPath":"'+ $(this).val() +'"}'
...
$(".dell").click(function(){
	...
	var text = '{"username":"'+ $(this).attr('id') +'"}';
	var formData = jQuery.parseJSON(text);
	var url = YAHOO.lang.substitute(Alfresco.constants.PROXY_URI_RELATIVE + "slingshot/searchdelete?query={query}",
	         ...
	         $.get(url, function(o){
					...
					if (o==true) {
						...
						window.location.href='/share/page/home-page';
					}
					else {
					    alert('Loi Yes3');
					}
...
$(".clickreportusername").click(function(){
	...
	if ($('.checkboxbttHTML').is(":checked"))
	{
		var win = window.open('/share/page/reportusername', '_blank');
		win.focus();
	}
	else
	{	
		var url = YAHOO.lang.substitute(Alfresco.constants.PROXY_URI_RELATIVE + "/zalu/report");
		 $.get(url, function(data){
			  $("#page-content").wordExportBaoCaoChiTiet("BaoCaoTongHopTheoNguoiDung", data, "Báo cáo tổng hợp theo người dùng", "Công văn, Hồ sơ", "username");
			});
	}
})
$(".clickreportyear").click(function(){
	...
	{	
		var url = YAHOO.lang.substitute(Alfresco.constants.PROXY_URI_RELATIVE + "/zalu/report");
		 $.get(url, function(data){
			  $("#page-content").wordExportBaoCaoChiTiet("BaoCaoTongHopTheoNam", data, "Báo cáo tổng hợp theo năm", "Công văn, Hồ sơ", "year");
			});
	}
})
